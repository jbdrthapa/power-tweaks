...
var DisplayClient = class DisplayClient extends BaseClient.BaseClient {
    constructor() {
        ...
        _handle = Main.panel.statusArea.aggregateMenu._brightness._proxy.connect('g-properties-changed', this._onBrightnessPropertiesChanged);

    }

    _onBrightnessPropertiesChanged() {
    ...
    Dispose() {
        ...
        Main.panel.statusArea.aggregateMenu._brightness._proxy.disconnect(_handle);
    }
